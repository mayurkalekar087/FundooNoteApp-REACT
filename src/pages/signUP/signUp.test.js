...
//testing existence of firstname and lastname
    it('renders a firstName input', () => {
        expect(shallow( < Register /> ).find('#firstName').length).toEqual(0)
    })
    it('renders a lastName input', () => {
        expect(shallow( < Register /> ).find('#lastName').length).toEqual(0)
    })
    it('renders a Email input', () => {
        expect(shallow( < Register /> ).find('#outlined-required').length).toEqual(0)
    })
    it('renders a Password input', () => {
        expect(shallow( < Register /> ).find('#outlined-adornment-password').length).toEqual(0)
    })
    it('renders a Service input', () => {
        expect(shallow( < Register /> ).find('#service').length).toEqual(0)
    })
